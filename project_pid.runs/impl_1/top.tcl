...
set rc [catch {
  ...
  set_property ip_repo_paths d:/Xilinx2016/Projetos_UERGS/Temp_ctrl_pid/project_pid.cache/ip [current_project]
  set_property ip_output_repo d:/Xilinx2016/Projetos_UERGS/Temp_ctrl_pid/project_pid.cache/ip [current_project]
  add_files -quiet D:/Xilinx2016/Projetos_UERGS/Temp_ctrl_pid/project_pid.runs/synth_1/top.dcp

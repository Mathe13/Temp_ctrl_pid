...
HD_PWD='C:/Users/matheus/Documents/project_pid/project_pid.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log threshold_ff.vdi -applog -m64 -messageDb vivado.pb -mode batch -source threshold_ff.tcl -notrace
